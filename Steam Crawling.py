...
while True:
    ...
    while True:
        ...
        while True:
            ...
            url = 'https://store.steampowered.com/search/?term={}'.format(gameTitle2)
            try:
    ...
    &appHubSubSection=10&appHubSubSection=10&l=english&filterLanguage=default&searchText=&forceanon=1'.format(gameId, i*10, (i+1), (i+1), (i+1), (i+1), (i+1), (i+1), (i+1), (i+1), (i+1), (i+1), (i+1), (i+1), gameId)
        ...
        for eachrev in reviewCards:
            comment = eachrev.find('div', {'class': 'apphub_CardTextContent'}).get_text()
    ...
    wordcloud = WordCloud(width = 800, height = 600, stopwords = wordset).generate(text)
    ...
    anotherGame = input('Press Enter to search for another game. Press E to exit\n>>')
